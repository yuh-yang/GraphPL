...
class FT_5(BaseModel):
    def __init__(self, dataset, pretrained_model=None, phase='pretrain'):
        ...
        if self.phase == 'pretrain' or self.phase == 'vanilla':
            ...
            self.emb_gate = lambda x: self.emb_dropout(self._minimal_gate(x))
    ...
    def _double_gate_1(self, emb):
        ...
        return reset * emb + (1-reset) * update * torch.tanh(emb)
